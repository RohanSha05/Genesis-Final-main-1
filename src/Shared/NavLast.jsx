			...
			<nav className="navbar bg-[#F5F5F5] h-[99px]">
				...
				<div className="relative h-full container mx-auto flex flex-wrap justify-between items-center px-[5%] ">
					...
					<div className="dropdown flex gap-4">
						...
						<button
							className="group text-orange-600 h-10 w-10"
							...
							<div className="flex flex-col p-4">
								...
								<ul className="menu  text-base-content min-h-full w-full p-4">
									<li>
										<img
											className="w-52 p-5"
											src="https://www.gtl.com.bd/img_upload/logo/474.png"
											alt="title"
										/>
									</li>
									...
									<div>
										...
										<div className="grid grid-cols-2 lg:grid-cols-4 gap-2 py-4 lg:max-w-72">
											<img
												...
												src="https://webextheme.com/html/loxicat/images/side-panel/1.jpg"
												alt="pintarest"
											/>
											<img
												className="rounded object-cover"
												src="https://webextheme.com/html/loxicat/images/side-panel/2.jpg"
												alt="pintarest"
											/>
											<img
												className="rounded object-cover"
												src="https://webextheme.com/html/loxicat/images/side-panel/3.jpg"
												alt="pintarest"
											/>
											<img
												className="rounded object-cover"
												src="https://webextheme.com/html/loxicat/images/side-panel/4.jpg"
												alt="pintarest"
											/>
											<img
												className="rounded object-cover"
												src="https://webextheme.com/html/loxicat/images/side-panel/5.jpg"
												alt="pintarest"
											/>
											<img
												className="rounded object-cover"
												src="https://webextheme.com/html/loxicat/images/side-panel/6.jpg"
												alt="pintarest"
											/>
										</div>
									</div>
