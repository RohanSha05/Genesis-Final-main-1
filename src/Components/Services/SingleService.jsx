  ...
  return (
    <div className="min-h-screen px-6 my-28 flex flex-col lg:flex-row justify-center">
      <div className=" w-full lg:w-[30%] flex flex-col gap-8  px-7">
        ...
        {data.services.map((service) => (
          <div
            ...
            className={`cursor-pointer flex py-2 items-center text-[16px] pl-5 gap-1 border-2 border-[#E2EBEF] bg-[#EEF4F8] w-[94%] h-[55px] transition-all duration-400 hover:border-l-[6px] hover:text-blue-500 hover:border-l-orange-500 ${
              selectedId === service.id ? 'border-l-[6px] text-blue-500 border-l-blue-500' : 'text-[#40496A]'
            }`}
          >
      ...
      <div className="w-full lg:w-[55%] flex flex-col items-start gap-7">
        {selectedImage && (
          <img
            src='https://img.freepik.com/free-photo/person-working-html-computer_23-2150038841.jpg'
