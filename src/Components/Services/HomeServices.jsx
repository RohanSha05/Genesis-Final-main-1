      ...
      <div className="my-10  grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {data.map((service) => (
          <div
            ...
            shadow-[rgba(0,0,0,0.2)_3px_3px_10px_1px,_rgba(0,0,0,0.2)_-3px_-3px_10px_1px] p-3  overflow-hidden transition-all duration-300 hover:-translate-y-2"
          >
            <div
            ...
            <div className="flex flex-col p-6 gap-5">
              ...
              />
              <h2 className="relative text-2xl font-bold cursor-pointer transition-all duration-300 font-rajdhani">
                {service.title}
              </h2>
