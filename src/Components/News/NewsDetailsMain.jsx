    ...
    <div className="container mx-auto max-w-[1200px] mt-8 grid grid-cols-1 md:grid-cols-3 gap-8 font-rajdhani">
      ...
      <div className="col-span-2">
        ...
        <div className="overflow-hidden">
          <img
            src="https://i.postimg.cc/bNLGJ1Qw/Rectangle-66.png" // Replace with your image source
        ...
        <div className="flex items-center text-sm text-gray-500 space-x-2 mt-4">
          <div className='text-lg text-blue-500'> <MdOutlinePersonOutline /></div><span>By <span className="text-blue-500">Admin</span></span> 
          <span className="flex items-center">
            <div className='text-lg text-blue-500'><MdOutlineCalendarMonth /></div>
            18 January, 2019
          </span>
          <span className="flex items-center">
            <div className='text-lg text-blue-500'><CiHeart /></div>
            245 Likes
          </span>
        </div>
      ...
      {/* Quote Box */}
      <div className="bg-gray-100 border-l-4 border-blue-500 p-6 mb-8">
    ...
    <div className="bg-white py-6">
      ...
      <button className="bg-[#00A1E6] p-3">
        ...
        <div className="bg-gray-100 shadow-md rounded-lg p-6 mb-6">
          <h2 className="text-2xl px-3 font-bold text-black bg-white  pb-4 border-l-4 border-blue-500 pl-2 mt-2">Categories</h2>
          <ul className="mt-4 space-y-6 mb-2">
            <li className="flex items-center border-b  ">
              <span className="text-blue-500"><CiHardDrive /></span>
              <span className="ml-2   font-medium text-base text-gray-600 hover:text-blue-500 ">Business</span>
            </li>
            <li className="flex items-center border-b">
              <span className="text-blue-500"><CiHardDrive /></span>
              <span className="ml-2 font-medium text-base text-gray-600 hover:text-blue-500">Consulting</span>
            </li>
            <li className="flex items-center border-b">
              <span className="text-blue-500"><CiHardDrive /></span>
              <span className="ml-2 font-medium text-base text-gray-600 hover:text-blue-500">Finance</span>
            </li>
            <li className="flex items-center border-b">
              <span className="text-blue-500"><CiHardDrive /></span>
              <span className="ml-2 font-medium text-base text-gray-600 hover:text-blue-500">Corporate</span>
            </li>
            <li className="flex items-center border-b">
              <span className="text-blue-500"><CiHardDrive /></span>
              <span className="ml-2 font-medium text-base text-gray-600 hover:text-blue-500">Conference</span>
            </li>
            <li className="flex items-center border-b">
              <span className="text-blue-500"><CiHardDrive /></span>
              <span className="ml-2 font-medium text-base text-gray-600 hover:text-blue-500">Economics</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-gray-100 shadow-md rounded-lg p-6">
          <h2 className="text-2xl px-3 font-bold text-black bg-white  pb-4 border-l-4 border-blue-500 pl-2">Popular Posts</h2>
          <ul className="mt-4 space-y-4">
            <li className="text-gray-600">
              <span className="block font-semibold text-black text-lg hover:text-blue-500 ">Business Solution</span>
      ...
      <div className="bg-gray-100 p-6 mb-8">
        <h2 className="text-2xl px-3 font-bold text-black bg-white  pb-4 border-l-4 border-blue-500 pl-2 ">
        ...
        <ul className="space-y-4 mb-2">
          {['January 2019', 'March 2019', 'April 2019', 'June 2019'].map((month, index) => (
            <li key={index} className="flex items-center">
              ...
              <a href="#" className="text-black text-lg  hover:text-blue-500">{month}</a>
            </li>
          ))}
        </ul>
      </div>
      ...
      <div className="bg-gray-100 p-6">
        <h2 className="text-2xl px-3 font-bold text-black bg-white  pb-4 border-l-4 border-blue-500 pl-2 mb-4">
